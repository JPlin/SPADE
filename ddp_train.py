...
from data import create_dataloader2
...
parser.add_argument('--local_rank', type=int, default=0) # extra args to launch
args = parser.parse_args()

# Setting up the process and device
...
if __name__ == '__main__':
    ...
    data_loader = create_dataloader2(opt)
    dataset_size = len(data_loader)
    print("# training images length ", dataset_size)
    opt['mode'] = 'test'
    test_data_loader = create_dataloader2(opt)
